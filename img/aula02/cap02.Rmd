...
Se $F_{obs} \not\in RC$ então **não rejeitamos** $H_0$ e concluímos que as variâncias são iguais ou seja, as variãncias são **HOMOCEDÁSTICAS**. 
...
Como $s^2_A > s^2_B$ vamos calcular o a estatística do teste:
