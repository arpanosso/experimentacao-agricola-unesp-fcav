...
subtitle: "11. ESTUDO DO FATORIAL 2³ - TRIFATORIAL"
...
Devemos agora, desdobrar a soma de quadrados e os graus de liberdade de tratamentos para estudar os efeitos principais e os efeitos das interações entre os fatores.
...
|Ef. NPK| $000$ | $100$ | $010$ | $001$ | $110$ | $101$ | $011$ | $111$ | $\hat{Y}$ |
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
|**N**|-|+|-|-|+|+|-|+|232,70|
|**P**|-|-|+|-|+|-|+|+|32,1|
|**K**|-|-|-|+|-|+|+|+|182,3|
...
E a soma de quadrados correspondente a um dado contraste $Y_i$ é dada por:
...
---
Uma vez obtidas as somas de quadrados, podemos montar o seguinte quadro de análise de variância.
