...
+ presença de veranico nos estágio iniciais de crescimento;
+ densidade do solo;
+ condutividade hídrica do solo;
+ teor de matéria orgância do solo;
+ temperatura;
+ incidência de luz. 
...
De modo geral, recomenda-se que o número de parcelas do experimento não seja inferior a $20$ e que o número de graus de liberdade associado aos efeitos dos fatores não controlado ou acaso não seja inferior a $10$.
...
$$F_{Trat}=\frac{QM_\text{Tratamentos}}{QM_\text{Resíduos} } = \frac{\sigma^2+K\sigma^2_t}{\sigma^2}$$
---
...
---
c) **Fobs > Ftab(1%)** - O teste é significativo ao nível de $1\%$de probabilidade.  
...
Os dados experimentais, em planilha eletrônica da seguinte forma, em planilha eletrônica [dados_prod_cana.xlsx](https://github.com/arpanosso/experimentacao-agricola-unesp-fcav/raw/master/data/dados_prod_cana.xlsx).
