...
Devem ser tomados cuidados para que a amostra seja representativa. Só assim, as inferências a partir dela poderão expressar uma extrapolação para a população (cultura de um modogeral).
...
$6$ Tratamentos x $5$ Repetições $= 30$ parcelas experimentais
